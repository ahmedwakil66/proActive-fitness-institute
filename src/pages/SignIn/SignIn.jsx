...
import { EyeFillIcon, EyeSlashFillIcon } from "../../utilities/Icons";
                ...
                <div className="lg:w-1/2 xl:max-w-screen-sm">
                    <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                        <div className="cursor-pointer flex items-center">
                            ...
                            {/* <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">ProActive</div> */}
                            <SocialSignIn from={from}/>
                        </div>
                    </div>
                    <div className="px-12 divider">OR</div>
                        ...
                        <div className="mt-12">
                            <form onSubmit={handleSubmit(handleLogin)}>
                                <div>
                                    ...
                                    <input className="blocky-input" type="email" placeholder="example@email.com" {...register("email", { required: true })}/>
                                </div>
                                <div className="mt-8 relative">
                                    ...
                                    <input className="blocky-input" type={show ? "text" : "password"} placeholder="Enter your password" {...register("password", { required: true })}/>
                                    <div onClick={() => setShow(!show)} className="absolute bottom-1 right-0">
                                        {show ? <button type="button"> <EyeSlashFillIcon size={20}/> </button>
                                        : <button type="button"> <EyeFillIcon size={20}/> </button>}
                                    </div>
                                </div>
                                <div className="mt-10">
